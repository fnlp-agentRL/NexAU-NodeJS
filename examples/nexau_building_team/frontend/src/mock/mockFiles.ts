    ...
    children: [
      {
        ...
        children: [
          {
            name: "search_enterprise.yaml",
            path: "skills/enterprise_query/search_enterprise.yaml",
            isDirectory: false,
            isFile: true,
            size: 320,
          },
          {
            name: "get_enterprise_detail.yaml",
            path: "skills/enterprise_query/get_enterprise_detail.yaml",
            isDirectory: false,
            isFile: true,
            size: 280,
          },
      ...
      },
      {
        ...
        children: [
          {
            name: "analyze_trend.yaml",
            path: "skills/business_analysis/analyze_trend.yaml",
            isDirectory: false,
            isFile: true,
            size: 360,
          },
          {
            name: "compare_enterprises.yaml",
            path: "skills/business_analysis/compare_enterprises.yaml",
            isDirectory: false,
            isFile: true,
            size: 310,
          },
          {
            name: "handler.py",
            path: "skills/business_analysis/handler.py",
            isDirectory: false,
            isFile: true,
            size: 1820,
          },
          {
            name: "SKILL.md",
            path: "skills/business_analysis/SKILL.md",
            isDirectory: false,
            isFile: true,
            size: 380,
          },
      ...
      },
      {
        ...
        children: [
          {
            name: "match_policy.yaml",
            path: "skills/policy_match/match_policy.yaml",
            isDirectory: false,
            isFile: true,
            size: 340,
          },
          {
            name: "list_policies.yaml",
            path: "skills/policy_match/list_policies.yaml",
            isDirectory: false,
            isFile: true,
            size: 290,
          },
          {
            name: "handler.py",
            path: "skills/policy_match/handler.py",
            isDirectory: false,
            isFile: true,
            size: 1650,
          },
          {
            name: "SKILL.md",
            path: "skills/policy_match/SKILL.md",
            isDirectory: false,
            isFile: true,
            size: 350,
          },
      ...
      },
      {
        ...
        children: [
          {
            name: "get_supply_chain.yaml",
            path: "skills/supply_chain/get_supply_chain.yaml",
            isDirectory: false,
            isFile: true,
            size: 320,
          },
          {
            name: "find_industry_cluster.yaml",
            path: "skills/supply_chain/find_industry_cluster.yaml",
            isDirectory: false,
            isFile: true,
            size: 350,
          },
          {
            name: "handler.py",
            path: "skills/supply_chain/handler.py",
            isDirectory: false,
            isFile: true,
            size: 1480,
          },
          {
            name: "SKILL.md",
            path: "skills/supply_chain/SKILL.md",
            isDirectory: false,
            isFile: true,
            size: 360,
          },
      ...
      },
      {
        ...
        children: [
          {
            name: "check_risk.yaml",
            path: "skills/risk_alert/check_risk.yaml",
            isDirectory: false,
            isFile: true,
            size: 310,
          },
          {
            name: "scan_abnormal.yaml",
            path: "skills/risk_alert/scan_abnormal.yaml",
            isDirectory: false,
            isFile: true,
            size: 340,
          },
          {
            name: "handler.py",
            path: "skills/risk_alert/handler.py",
            isDirectory: false,
            isFile: true,
            size: 1720,
          },
          {
            name: "SKILL.md",
            path: "skills/risk_alert/SKILL.md",
            isDirectory: false,
            isFile: true,
            size: 370,
          },
