        ...
        {questions.map((q, i) => {
          ...
          return (
            <div key={i} style={styles.questionBlock}>
              ...
              {q.multiSelect && <div style={styles.multiSelectHint}>Select multiple</div>}
        ...
        return (
          ...
          >
            <span style={styles.optLabel}>
              <MarkdownRenderer content={normalizeNewlines(opt.label)} inline />
            </span>
            {opt.description && (
              <span style={styles.optDesc}>
                <MarkdownRenderer content={normalizeNewlines(opt.description)} inline />
              </span>
            )}
          </button>
        );
 ...
 */
export function parseAskUserQuestions(argsJson: string, partial = false): AskUserQuestion[] | null {
  try {
