...
- **Advanced Guides**
  ...
  - **[Streaming Events](./advanced-guides/streaming-events.md)** ⚠️ _Experimental_: Incremental, provider-agnostic events (text deltas, tool calls, etc.) for streaming UIs.
  - **[Session Management](./advanced-guides/session-management.md)** ⚠️ _Experimental_: Stateful session persistence, agent tracking, and concurrency control.
  - **[Transport System](./advanced-guides/transports.md)** ⚠️ _Experimental_: Multi-protocol communication (HTTP/SSE, stdio today; WebSocket, gRPC may be added later).
